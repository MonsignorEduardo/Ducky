...
export namespace Prisma {
  ...
  */
  ...
  type GetCommandGroupByPayload<T extends CommandGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type CommandGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof Command ? Command[P] : never
  } 
    : Command
  : Command
  ...
  export interface CommandDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Command'> extends True ? CheckSelect<T, Prisma__CommandClient<Command>, Prisma__CommandClient<CommandGetPayload<T>>> : CheckSelect<T, Prisma__CommandClient<Command | null, null>, Prisma__CommandClient<CommandGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Command'> extends True ? CheckSelect<T, Prisma__CommandClient<Command>, Prisma__CommandClient<CommandGetPayload<T>>> : CheckSelect<T, Prisma__CommandClient<Command | null, null>, Prisma__CommandClient<CommandGetPayload<T> | null, null>>
    ...
    **/
    ...
    /**
     * Find one Command that matches the filter or throw
     * `NotFoundError` if no matches were found.
     ...
     * })
    **/
    findUniqueOrThrow<T extends CommandFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, CommandFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__CommandClient<Command>, Prisma__CommandClient<CommandGetPayload<T>>>
     ...
     * })
    **/
    findFirstOrThrow<T extends CommandFindFirstOrThrowArgs>(
      args?: SelectSubset<T, CommandFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__CommandClient<Command>, Prisma__CommandClient<CommandGetPayload<T>>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, CommandGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCommandGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__CommandClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  /**
   * Command base type for findUnique actions
   */
  export type CommandFindUniqueArgsBase = {
    /**
   ...
   * Command: findUnique
   */
  export interface CommandFindUniqueArgs extends CommandFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * Command base type for findFirst actions
   */
  export type CommandFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Command
     * 
    **/
   ...
   * Command: findFirst
   */
  export interface CommandFindFirstArgs extends CommandFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   */
  export type CommandFindUniqueOrThrowArgs = CommandFindUniqueArgsBase
      

  /**
   * Command: findFirstOrThrow
   */
  export type CommandFindFirstOrThrowArgs = CommandFindFirstArgsBase
  ...
  export type CommandWhereInput = {
    ...
    matches?: StringFilter | string
    response?: StringFilter | string
    extraResponse?: StringFilter | string
    timer?: IntFilter | number
    lastCall?: DateTimeFilter | Date | string
  }
  ...
  export type CommandScalarWhereWithAggregatesInput = {
    ...
    matches?: StringWithAggregatesFilter | string
    response?: StringWithAggregatesFilter | string
    extraResponse?: StringWithAggregatesFilter | string
    timer?: IntWithAggregatesFilter | number
    lastCall?: DateTimeWithAggregatesFilter | Date | string
  }
  ...
  export type CommandUpdateInput = {
    ...
    extraResponse?: StringFieldUpdateOperationsInput | string
    timer?: IntFieldUpdateOperationsInput | number
    lastCall?: DateTimeFieldUpdateOperationsInput | Date | string
  }
